(() => {
  ...
  const I18N = {
    en: {
      ...
      hero_kicker: "Field atlas",
      hero_title_line_1: "Local presence,",
      hero_title_line_2: "drawn as",
      hero_title_accent: "paper signals.",
      hero_lead: "Track activity, map nearby motion, and coordinate tasks without exposing precise location.",
      ...
      hero_feature_sub: "All demo workflows run entirely locally with enterprise-grade privacy controls and are production-ready out of the box.",
      section_activity: "Activity Logger",
      section_map: "Live Map",
      section_marketplace: "Tasks & Market",
      quick_actions_label: "Do now",
      ...
      workspace_overview_label: "System readout",
      overview_aura_title: "Aura",
      overview_map_title: "Map",
      overview_market_title: "Market",
    ...
    "zh-Hant": {
      ...
      hero_kicker: "場域圖志",
      hero_title_line_1: "在地存在，",
      hero_title_line_2: "化成",
      hero_title_accent: "紙上訊號。",
      hero_lead: "記錄活動、查看附近動態並協調任務，同時避免暴露精確位置。",
      ...
      quick_actions_label: "立即操作",
      quick_start_activity: "開始活動",
      quick_locate_me: "地圖置中",
      quick_post_task: "發布任務",
      quick_post_service: "發布服務",
      quick_schedule_event: "建立排程",
      workspace_overview_label: "系統讀取",
      overview_aura_title: "氣場",
      overview_map_title: "地圖",
      overview_market_title: "市集",
    ...
    ja: {
      ...
      hero_kicker: "フィールドアトラス",
      hero_title_line_1: "街の気配を、",
      hero_title_line_2: "紙の",
      hero_title_accent: "シグナルへ。",
      hero_lead: "活動を記録し、周辺の動きを見て、タスクを調整しながらも正確な位置は出しません。",
      ...
      quick_actions_label: "今すぐ操作",
      quick_start_activity: "活動を開始",
      quick_locate_me: "地図を中央へ",
      quick_post_task: "タスク投稿",
      quick_post_service: "サービス投稿",
      quick_schedule_event: "予定を作成",
      workspace_overview_label: "システム読取",
      overview_aura_title: "オーラ",
      overview_map_title: "マップ",
      overview_market_title: "マーケット",
